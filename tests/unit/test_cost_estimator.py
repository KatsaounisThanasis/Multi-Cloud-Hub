...
class TestCostEstimatorAzure:
    ...
    async def test_azure_vm_realtime_success(self, mock_get_client):
        ...
        mock_client.get_vm_pricing.return_value = {"retail_price_per_month": 80.0, "product_name": "Test VM Product"}
        mock_client.get_disk_pricing.return_value = {"price_per_month": 5.0}
    ...
    async def test_azure_storage_realtime_success(self, mock_get_client):
        # Setup Mock
        mock_client = AsyncMock()
        mock_client.get_storage_pricing.return_value = {"price_per_gb_month": 0.02, "product_name": "Standard LRS"}
        mock_get_client.return_value = mock_client
...
class TestCostEstimatorGCP:
    ...
    async def test_gcp_vm_realtime_success(self, mock_get_client):
        ...
        mock_client.get_disk_pricing.return_value = {"price_per_gb_month": 0.04}
        mock_get_client.return_value = mock_client
